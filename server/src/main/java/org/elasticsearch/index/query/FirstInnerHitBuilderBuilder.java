...
public final class FirstInnerHitBuilderBuilder implements Writeable, ToXContentObject {
    ...
    private static final ObjectParser<FirstInnerHitBuilderBuilder, Void> PARSER = new ObjectParser<>("inner_hits", FirstInnerHitBuilderBuilder::new);

    static {
        PARSER.declareString(FirstInnerHitBuilderBuilder::setName, NAME_FIELD);
        PARSER.declareString(FirstInnerHitBuilderBuilder::setValue, VALUE_FIELD);
        PARSER.declareBoolean((innerHitBuilder, value) -> innerHitBuilder.ignoreUnmapped = value, IGNORE_UNMAPPED);
        PARSER.declareInt(FirstInnerHitBuilderBuilder::setFrom, SearchSourceBuilder.FROM_FIELD);
        PARSER.declareInt(FirstInnerHitBuilderBuilder::setSize, SearchSourceBuilder.SIZE_FIELD);
        PARSER.declareBoolean(FirstInnerHitBuilderBuilder::setExplain, SearchSourceBuilder.EXPLAIN_FIELD);
        PARSER.declareBoolean(FirstInnerHitBuilderBuilder::setVersion, SearchSourceBuilder.VERSION_FIELD);
        PARSER.declareBoolean(FirstInnerHitBuilderBuilder::setSeqNoAndPrimaryTerm, SearchSourceBuilder.SEQ_NO_PRIMARY_TERM_FIELD);
        PARSER.declareBoolean(FirstInnerHitBuilderBuilder::setTrackScores, SearchSourceBuilder.TRACK_SCORES_FIELD);
        PARSER.declareStringArray(FirstInnerHitBuilderBuilder::setStoredFieldNames, SearchSourceBuilder.STORED_FIELDS_FIELD);
        PARSER.declareObjectArray(FirstInnerHitBuilderBuilder::setDocValueFields,
        ...
        PARSER.declareObject(FirstInnerHitBuilderBuilder::setHighlightBuilder, (p, c) -> HighlightBuilder.fromXContent(p),
    ...
    public FirstInnerHitBuilderBuilder() {
        this.name = null;
    }

    public FirstInnerHitBuilderBuilder(String name) {
        this.name = name;
    }
     ...
     * Read from a stream.
     */
    public FirstInnerHitBuilderBuilder(StreamInput in) throws IOException {
    ...
    /**
     * BWC serialization for nested {@link FirstInnerHitBuilderBuilder}.
    ...
    /**
     * BWC serialization for collapsing {@link FirstInnerHitBuilderBuilder}.
    ...
    /**
     * BWC serialization for parent/child {@link FirstInnerHitBuilderBuilder}.
    ...
    public FirstInnerHitBuilderBuilder setName(String name) {
        this.name = Objects.requireNonNull(name);
        return this;
    }


    public FirstInnerHitBuilderBuilder setValue(String value) {
        this.value = Objects.requireNonNull(value);
        return this;
    }

    public FirstInnerHitBuilderBuilder setIgnoreUnmapped(boolean value) {
    ...
    public FirstInnerHitBuilderBuilder setFrom(int from) {
        if (from < 0) {
    ...
    public FirstInnerHitBuilderBuilder setSize(int size) {
        if (size < 0) {
    ...
    public FirstInnerHitBuilderBuilder setExplain(boolean explain) {
    ...
    public FirstInnerHitBuilderBuilder setVersion(boolean version) {
    ...
    public FirstInnerHitBuilderBuilder setSeqNoAndPrimaryTerm(boolean seqNoAndPrimaryTerm) {
    ...
    public FirstInnerHitBuilderBuilder setTrackScores(boolean trackScores) {
     ...
     *
     * @deprecated Use {@link FirstInnerHitBuilderBuilder#getStoredFieldsContext()} instead.
     */
    @Deprecated
     ...
     *
     * @deprecated Use {@link FirstInnerHitBuilderBuilder#setStoredFieldNames(List)} instead.
     */
    @Deprecated
    public FirstInnerHitBuilderBuilder setFieldNames(List<String> fieldNames) {
     ...
     * If none are specified, the source of the document will be returned.
     */
    public FirstInnerHitBuilderBuilder setStoredFieldNames(List<String> fieldNames) {
     ...
     */
    public FirstInnerHitBuilderBuilder setDocValueFields(List<FieldAndFormat> docValueFields) {
     ...
     */
    public FirstInnerHitBuilderBuilder addDocValueField(String field, String format) {
        if (docValueFields == null) {
     ...
     */
    public FirstInnerHitBuilderBuilder addDocValueField(String field) {
    ...
    public FirstInnerHitBuilderBuilder setScriptFields(Set<ScriptField> scriptFields) {
        this.scriptFields = scriptFields;
        return this;
    }

    public FirstInnerHitBuilderBuilder addScriptField(String name, Script script) {
    ...
    public FirstInnerHitBuilderBuilder setFetchSourceContext(FetchSourceContext fetchSourceContext) {
    ...
    public FirstInnerHitBuilderBuilder setSorts(List<SortBuilder<?>> sorts) {
        this.sorts = sorts;
        return this;
    }

    public FirstInnerHitBuilderBuilder addSort(SortBuilder<?> sort) {
        if (sorts == null) {
            sorts = new ArrayList<>();
        }
        sorts.add(sort);
    ...
    public FirstInnerHitBuilderBuilder setHighlightBuilder(HighlightBuilder highlightBuilder) {
    ...
    public FirstInnerHitBuilderBuilder setInnerCollapse(CollapseBuilder innerCollapseBuilder) {
    ...
    public boolean equals(Object o) {
        ...
        FirstInnerHitBuilderBuilder that = (FirstInnerHitBuilderBuilder) o;
    ...
    public static FirstInnerHitBuilderBuilder fromXContent(XContentParser parser) throws IOException {
        return PARSER.parse(parser, new FirstInnerHitBuilderBuilder(), null);
    }
